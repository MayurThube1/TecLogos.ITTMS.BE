...
using UpdateTicketStatusRequestDTO = TecLogos.ITTMS.Models.DTOs.UpdateTicketStatusRequestDTO;
using ScheduleAppointmentRequestDTO = TecLogos.ITTMS.Models.DTOs.ScheduleAppointmentRequestDTO;
